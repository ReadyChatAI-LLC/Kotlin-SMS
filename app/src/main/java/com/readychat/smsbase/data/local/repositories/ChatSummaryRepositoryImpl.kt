...
class ChatSummaryRepositoryImpl @Inject constructor(
    ...
    override suspend fun insertChatSummary(summary: ChatSummaryEntity) {
        chatSummaryDao.insertChatSummary(summary)
    }

    override suspend fun getChatSummaryByAddress(address: String): ChatSummaryEntity? {
        return chatSummaryDao.getChatSummaryByAddress(address)
    }
}
