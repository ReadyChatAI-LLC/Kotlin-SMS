...
interface IChatDetailsRepository {
    ...
    suspend fun addTextMessage(textMessage: TextMessageModel, customContactName: String?)
    ...
    suspend fun createEmptyChatIfNotExists(address: String, contactName: String)
}
